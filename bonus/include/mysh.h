...
*/
    ...
    #define PATH_CONTENT_BASE "/bin:/usr/bin"
...
int change_or_create(char *var, char *value, linked_list_t **head);
bool is_env_variable(linked_list_t **env, char *var);
...
/* operators */
int error_redirect(tree_t *branch, char *error_msg);
...
int exec_pipe2(tree_t *tree, linked_list_t **env);
...
int exec_rr_r2(tree_t *tree, linked_list_t **env, int mode);
int exec_rr2(tree_t *tree, linked_list_t **env);
int exec_r2(tree_t *tree, linked_list_t **env);
...
static const type_to_func_t type_to_func_list[] = {
    ...
    {PIPE2, &exec_pipe2, NULL},
    {REDIRECTION_R2, &exec_r2, NULL},
    {REDIRECTION_RR2, &exec_rr2, NULL},
};
